...
| 画幅 | `16:9` |
| 官网用途 | TACT 质量 |
| 建议输出 | `images/generated/tact/tact-qc-rework.png` |
...
QC screen: pass/fail for operation, photo evidence grid, rework ticket assigned to paint team,
status 返工中→复检. Distinguish 车间放行 vs 实际交车 badges. Strict audit feel.
