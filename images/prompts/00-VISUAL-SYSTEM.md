...
用户明确要求整页更大胆、大量粒子和更美观的 Hero。本地新版采用 [流动的智能](../../docs/visual-style-v2.md)：有机连续丝带、玉绿粒子、少量香槟点光；浅色暖白、深色墨绿，始终跟随系统主题。`brand-luminous-field-v1` 及其 dark 版本采用这套方向，允许通透光带和粒子辉光，替代下面旧 editorial-system 的金属模块与克制光线要求。仅品牌装饰使用此例外，产品 UI、Logo、匿名数据和无文字要求仍适用。
